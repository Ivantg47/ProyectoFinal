...
<body>
	...
	<div class="form alta">
		<form name="subir" id="subir" class="row g-3" method="post" action="elimina_compositor.php">
			<h4 class="col-12">Baja Compositor</h4>

      <input id="doc" type="text" name="doc" value="elimina_compositor.php" style="display: none" > 
