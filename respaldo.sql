...
--
-- Name: bdrecords; Type: DATABASE; Schema: -; Owner: discos_dbo
--
CREATE USER discos_dbo WITH ENCRYPTED PASSWORD 'hola';
CREATE USER discos_reader WITH ENCRYPTED PASSWORD 'hola';
CREATE USER discos_oper WITH ENCRYPTED PASSWORD 'hola';

CREATE DATABASE bdrecords WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE = 'es_MX.UTF-8';
...
34	SSS AA	AA SS	PPP TT	2022-05-10	INDEFINIDO
2	Leon Ruben	Larregui Marin	México	1973-12-01	INDEFINIDO
3	Alvaro Gonzalo	Lopez Parra	Chile	1979-11-04	INDEFINIDO
4	Enrique	Rangel	México	1973-11-09	INDEFINIDO
5	Alvaro	Arizaleta	España	1980-10-05	INDEFINIDO
6	Alfonso	Pichardo	México	1973-02-01	INDEFINIDO
10	Ximena	Sariñana	México	1985-10-20	INDEFINIDO
11	Adrian	Dargelos	Argentina	2069-01-03	INDEFINIDO
31	Ray	Manzerak	Inglaterra	2045-02-18	INDEFINIDO
32	Santi	Balmes	España	1975-10-15	INDEFINIDO
33	Jordi	Roig	España	1975-09-09	INDEFINIDO
...
27	LOREM	IPSUM	IPSUM	2022-05-18
\.
...
22	ssss	6	2022-05-12	ss	12	14	2222	img/ssss612
23	d	6	2022-05-12	dddddd	12	14	2222	img/d612
24	2b	14	2022-05-11	juego	15	10	200	img/2b-24-14-15
\.
...
22	LOREM	IPSUM	2022-05-18
23	GUSTAVO	SANTOALLA	1947-10-01
\.
...
SELECT pg_catalog.setval('public.canciones_cancion_id_seq', 38, true);
...
SELECT pg_catalog.setval('public.compositores_compositor_id_seq', 27, true);
...
SELECT pg_catalog.setval('public.discos_disco_id_seq', 24, true);
...
SELECT pg_catalog.setval('public.productores_productor_id_seq', 24, true);
...
--
-- Name: DATABASE bdrecords; Type: ACL; Schema: -; Owner: discos_dbo
--

GRANT CONNECT ON DATABASE bdrecords TO discos_reader;
...
--
-- Name: SEQUENCE artistas_artista_id_seq; Type: ACL; Schema: public; Owner: discos_dbo
--

GRANT SELECT,USAGE ON SEQUENCE public.artistas_artista_id_seq TO discos_oper;
...
--
-- Name: SEQUENCE canciones_cancion_id_seq; Type: ACL; Schema: public; Owner: discos_dbo
--

GRANT SELECT,USAGE ON SEQUENCE public.canciones_cancion_id_seq TO discos_oper;
...
--
-- Name: SEQUENCE compositores_compositor_id_seq; Type: ACL; Schema: public; Owner: discos_dbo
--

GRANT SELECT,USAGE ON SEQUENCE public.compositores_compositor_id_seq TO discos_oper;


--
-- Name: SEQUENCE discos_disco_id_seq; Type: ACL; Schema: public; Owner: discos_dbo
--

GRANT SELECT,USAGE ON SEQUENCE public.discos_disco_id_seq TO discos_oper;
...
--
-- Name: SEQUENCE disqueras_disquera_id_seq; Type: ACL; Schema: public; Owner: discos_dbo
--

GRANT SELECT,USAGE ON SEQUENCE public.disqueras_disquera_id_seq TO discos_oper;
...
--
-- Name: SEQUENCE grupos_grupo_id_seq; Type: ACL; Schema: public; Owner: discos_dbo
--

GRANT SELECT,USAGE ON SEQUENCE public.grupos_grupo_id_seq TO discos_oper;
...
--
-- Name: SEQUENCE productores_productor_id_seq; Type: ACL; Schema: public; Owner: discos_dbo
--

GRANT SELECT,USAGE ON SEQUENCE public.productores_productor_id_seq TO discos_oper;
...
--
-- Name: SEQUENCE usuario_id_seq; Type: ACL; Schema: public; Owner: discos_dbo
--

GRANT SELECT,USAGE ON SEQUENCE public.usuario_id_seq TO discos_oper;
